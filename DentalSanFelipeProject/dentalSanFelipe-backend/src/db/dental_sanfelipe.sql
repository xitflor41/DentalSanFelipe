...
CREATE TABLE IF NOT EXISTS procedimiento (
  ...
  descripcion TEXT,
  categoria VARCHAR(100) COMMENT 'Ej: Endodoncia, Ortodoncia, Cirugía, Limpieza, Restauración, etc.',
  costo_base DECIMAL(10,2),
  duracion_estimada INT COMMENT 'Duración estimada en minutos',
  activo BOOLEAN DEFAULT TRUE,
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS notificaciones (
  ...
  telefono VARCHAR(30) NOT NULL COMMENT 'Número de WhatsApp del paciente',
  mensaje TEXT NOT NULL COMMENT 'Mensaje de recordatorio a enviar por WhatsApp',
  fecha_programada TIMESTAMP NULL COMMENT 'Fecha programada para envío automático',
  fecha_envio TIMESTAMP NULL COMMENT 'Fecha real de envío',
  intentos INT DEFAULT 0,
  enviado BOOLEAN DEFAULT FALSE,
  whatsapp_msg_id VARCHAR(255) COMMENT 'ID del mensaje de WhatsApp',
  detalle_error TEXT,
  creado_por INT NULL,
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Notificaciones de WhatsApp para recordatorios de citas';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Registro de auditoría de todas las operaciones en expedientes';
