...
export const uploadAdjunto = async (req, res, next) => {
  try {
    ...
    const [r] = await pool.query(
      "INSERT INTO adjuntos (id_expediente, nombreArchivo, rutaArchivo, tipoArchivo, creado_por) VALUES (?, ?, ?, ?, ?)",
      [id_expediente, nombre || req.file.originalname, rutaRel, req.file.mimetype, req.user?.id_usuario || null]
    );
